...
const WorkShop = (props) => {
    ...
    localStorage.setItem('background', props.pickBackground)
    const backgroundlocal = localStorage.getItem('background');
        ...
        return (
            <>
                ...
                >
                    ...
                    <SpeedDialAction icon={actions.save.icon} tooltipTitle={actions.save.tooltip} />
